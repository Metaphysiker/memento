Rails.application.routes.draw do
  ...
  post '/people_create_letters_with_template/', to: 'people#create_letters_with_template', as: 'create_letters_with_template'
  ...
  get 'blog_list_year/(:date)/(:language)', to: 'blogs#blog_list_year', as: "blog_list_year"
